...
namespace Chneau.Time
{
    ...
    {
        internal List<uint> points = new List<uint>(); // 	0 to 4_294_967_295, which is good since > 60*60*24*7 = 604_800
        private static readonly Dictionary<string, int> DAYS = new Dictionary<string, int> { { "su", 0 }, { "mo", 1 }, { "tu", 2 }, { "we", 3 }, { "th", 4 }, { "fr", 5 }, { "sa", 6 } };
