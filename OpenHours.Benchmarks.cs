...
public static class OpenHoursBenchmarks
{
    public static void RunBenchmarks(TextWriter? writer = null)
    {
        ...
        sw.Stop();
        writer.WriteLine(
            $"1. IsOpen (100k rolling calls):            {sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMicroseconds / (iterations * 10 * benchScale):F3} us/op)"
        );
        ...
        sw.Stop();
        writer.WriteLine(
            $"2. IsOpen (1M pure calls):                 {sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMicroseconds / (1_000_000 * benchScale):F3} us/op)"
        );
        ...
        sw.Stop();
        writer.WriteLine(
            $"3. GetTimeToOpen (10k calls):              {sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMicroseconds / (iterations * benchScale):F3} us/op)"
        );
        ...
        sw.Stop();
        writer.WriteLine(
            $"4. GetTimeToOpenForDuration 4h (10k calls):{sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMicroseconds / (iterations * benchScale):F3} us/op)"
        );
        ...
        sw.Stop();
        writer.WriteLine(
            $"5. When 4h (10k calls):                    {sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMicroseconds / (iterations * benchScale):F3} us/op)"
        );
        ...
        sw.Stop();
        writer.WriteLine(
            $"6. NextDur (10k calls):                    {sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMicroseconds / (iterations * benchScale):F3} us/op)"
        );
        ...
        sw.Stop();
        writer.WriteLine(
            $"7. NextDate (10k calls):                   {sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMicroseconds / (iterations * benchScale):F3} us/op)"
        );
        ...
        sw.Stop();
        writer.WriteLine(
            $"8. Parse Cached (1k calls):                {sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMicroseconds / (1000 * benchScale):F3} us/op)"
        );
        ...
        sw.Stop();
        writer.WriteLine(
            $"9. JSON Deserialize (1k calls):            {sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMicroseconds / (1000 * benchScale):F3} us/op)"
        );

        // 10. Simulation Stress Test (5,000 unique locations)
        sw.Restart();
        var locations = new List<OpenHours>(5000 * benchScale);
        ...
        sw.Stop();
        writer.WriteLine(
            $"10. Stress Test (5,000 unique objects):    {sw.ElapsedMilliseconds,4} ms ({sw.Elapsed.TotalMilliseconds / (5000 * benchScale):F4} ms/obj)"
        );
        writer.WriteLine("========================================================");
    }
}
